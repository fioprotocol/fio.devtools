...
echo ------------------------------------------
echo ${fioactor}
dataJson="{\"payer_fio_address\":\"casey@dapixdev\",\"payee_fio_address\":\"adam@dapixdev\",\"content\":\"gobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobblegobble\",\"fio_request_id\":\"0\",\"max_fee\":\"40000000000\",\"actor\":\"${fioactor}\",\"tpid\":\"adam@dapixdev\"}"
expectedPackedData=056461706978104208414933a95b
cmd="programs/clio/clio --no-auto-keosd --url http://$hostname:$nPort --wallet-url http://$hostname:$wPort  convert pack_action_data fio.reqobt recordobt '$dataJson'"
echo CMD: $cmd
...
cmd="./programs/clio/clio --no-auto-keosd --url http://localhost:8889  --wallet-url http://localhost:9899 sign '$unsignedRequest' -k ${fioprivatekey}"
echo CMD: $cmd
