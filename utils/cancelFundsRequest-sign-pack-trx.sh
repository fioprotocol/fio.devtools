...
dataJson="{\"fio_request_id\":\"0\",\"max_fee\":400000000000,\"actor\":\"${fioactor}\",\"tpid\":\"adam@dapixdev\"}"
expectedPackedData=056461706978104208414933a95b
cmd="programs/clio/clio --no-auto-keosd --url http://$hostname:$nPort --wallet-url http://$hostname:$wPort  convert pack_action_data fio.reqobt cancelfndreq '$dataJson'"
echo CMD: $cmd
