...
fioprivatekey="5J7ocyimcfcR6LMQmC43uo7JUBS5eRPbTwiJuH4qP77tToSZTVJ"
...
dataJson="{\"producers\":[\"bp3@dapixdev\"],\"fio_address\":\"freddie@dapixdev\",\"actor\":\"ncmmejvfrgyb\",\"max_fee\":\"100000000000\"}"
expectedPackedData=056461706978104208414933a95b
cmd="programs/clio/clio --no-auto-keosd --url http://$hostname:$nPort --wallet-url http://$hostname:$wPort  convert pack_action_data eosio voteproducer '$dataJson'"
echo CMD: $cmd
