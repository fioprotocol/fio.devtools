...
dataJson="{
  \"fio_address\": \"${domain}\",
\"public_addresses\": [{\"chain_code\":\"DAI\",\"token_code\":\"DAI\",\"public_address\":\"eddieaddr\"}],
  \"max_fee\":\"3000000000\",
  \"actor\": \"${fioactor}\",
  \"tpid\": \"adam@dapixdev\"
}"
...
cmd="programs/clio/clio --no-auto-keosd --url http://$hostname:$nPort --wallet-url http://$hostname:$wPort  convert pack_action_data fio.address remaddress '${dataJson}'"
echo CMD: $cmd
