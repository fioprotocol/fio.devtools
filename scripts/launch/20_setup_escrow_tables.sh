...
echo 'buying domain'
clio -u http://localhost:8889 push action fio.escrow buydomain '{"buyer":"g4oc1qkysew2", "fio_domain":"blah", "marketplace":"market"}' -p g4oc1qkysew2@active
clio -u http://localhost:8889 push action fio.escrow buydomain '{"buyer":"g4oc1qkysew2", "fio_domain":"doctor", "marketplace":"market"}' -p g4oc1qkysew2@active
#
