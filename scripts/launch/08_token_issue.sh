...
./clio -u http://localhost:8879 push action fio.token issue '["htjonrkf1lgs","1000.000000000 FIO","memo"]' -p eosio@active
...
#Faucet
./clio -u http://localhost:8879 push action fio.token issue '["qhh25sqpktwh","1000000.000000000 FIO","memo"]' -p eosio@active
...
./clio -u http://localhost:8879 push action fio.token issue '["wjeo4abnk4c2","10000.000000000 FIO","memo"]' -p eosio@active

# contract holder account
./clio -u http://localhost:8879 push action fio.token issue '["p2yrhsvsvjge","10000.000000000 FIO","memo"]' -p eosio@active

#buyer account
./clio -u http://localhost:8879 push action fio.token issue '["g4oc1qkysew2","10000.000000000 FIO","memo"]' -p eosio@active

#extras
./clio -u http://localhost:8879 push action fio.token issue '["ltllcgohc4op","10000.000000000 FIO","memo"]' -p eosio@active
./clio -u http://localhost:8879 push action fio.token issue '["aghsbgzbx3iz","10000.000000000 FIO","memo"]' -p eosio@active
