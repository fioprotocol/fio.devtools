...
#  ../fio/build/bin/clio -u http://localhost:8889 push action -j fio.token trnsfiopubky '{"payee_public_key": "'FIO5oQPqujG8qiKkNPuWbdm8NGiYM3STuhHS8bXQ2dgNDaEg1aYNr'", "amount": 700000000000, "max_fee": "40000000000", "actor": "xbfugtkzvowu","tpid":""}' -p xbfugtkzvowu@active
...
# ../fio/build/bin/clio -u http://localhost:8889 push action -j fio.staking stakefio '{"fio_address":"","amount":100000000000,"max_fee":400000000000, "tpid":"","actor":"xbfugtkzvowu"}' -p xbfugtkzvowu@active
...
./clio -u http://localhost:8889 push action -j fio.token trnsfiopubky '{"payee_public_key": "'FIO6ydLCnUfsEMpbp35kF8oaUbHvcmLEyswMUF75C4FQAm78DUhAi'", "amount": 1000000000000000, "max_fee": "40000000000", "actor": "eosio","tpid":""}' -p eosio@active
